...
def main(args):
    ...
    if args.mode == 'Q_learning':
        ...
        player1.set_gamma(0.9)
        player1.set_update_target_every(5)
        player1.set_greedy_factor(0.1)
        player2.set_gamma(0.9)
        player2.set_update_target_every(5)
        player2.set_greedy_factor(1)
        player3.set_gamma(0.9)
        player3.set_update_target_every(5)
